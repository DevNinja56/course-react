                            ...
                            <div className="flex justify-between w-full">
                                <div className="flex flex-col gap-12 w-3/5">
                                    ...
                                    <div className="flex flex-col bg-white bg-opacity-10 gap-1">
                                        ...
                                        >
                                            The University of Portsmouth is the
                                            25th largest in the UK and dates
                                            back to the opening of the
                                            Portsmouth and Gosport School of
                                            Science & Art in 1870. After years
                                            as a Polytechnic, it became a
                                            university in 1992 and currently has
                                            around 28,000 students. More than
                                            4,000 of these are international
                                            ...
                                            <span className="text-opacity-0 bg-white">
                                                ...
                                                Portsmouth has been ranked as
                                                world-leading or internationally
                                                excellent for its research
                                                facilities.
                                            </span>
                                        </h1>
                                        {showText ? (
