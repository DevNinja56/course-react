...
const Home = () => {
    return (
        <>
                ...
                <div className="w-full flex items-center justify-center h-full md:h-[90vh] bg-heroSectionImage bg-cover pb-5 md:pb-0">
                    <div className="flex flex-col gap-8 md:gap-20 lg:gap-28 z-10 pt-14 w-full px-2 md:px-0">
                        <div className="flex flex-col gap-6 lg:gap-12 items-center">
                            ...
                            <SmartMatchButton
                                text="Find Your Course With"
                                link={ROUTES.SMART_MATCH_TOOL}
                            />
                        </div>
                        <div className="py-5 px-4 md:px-8 lg:px-12 flex-wrap md:flex-nowrap gap-7 flex items-center justify-around md:justify-between rounded-2xl bg-black/35 mx-auto w-full md:w-10/12 lg:w-8/12 xl:w-7/12 md:gap-6">
                            <HeroSectionCard
                                Icon={
            ...
            <div className="w-full flex flex-col lg:flex-row items-center justify-between px-2 md:px-8 lg:px-20 xl:px-40 py-5 md:py-16 gap-10 lg:gap-0 relative">
                ...
                <div className="relative w-10/12 md:w-7/12 lg:w-5/12 xl:w-4/12">
                    <Image
                        height={2483}
                        width={2710}
                    ...
                    />
                    <div className="absolute bottom-14 md:bottom-20 xl:bottom-16 -left-5 md:-left-8 lg:-left-10 xl:-left-8 flex flex-col">
                        <h1 className="text-xs md:text-base font-bold text-blueColor">
                            Tailored Suggestions
                        </h1>
                        <p className="text-[8px] md:text-xs">
                            Receive personalized results that <br /> fit your
            ...
            <HomeLearnMoreSection
                ...
                circleStyling="bottom-0 top-64 lg:top-44 -right-3 rotate-180"
                leftSideContent
            ...
            />
            <HomeLearnMoreSection
                image="/images/Home/home-ucas-image.svg"
                imageSize="w-9/12 md:w-6/12 lg:w-5/12 xl:w-[34%] lg:pl-12"
            ...
            <div className="w-full bg-blueColor z-10 relative py-8">
                ...
                <div className="w-full lg:w-8/12 mx-auto flex items-center justify-between flex-col-reverse md:flex-row gap-10 md:gap-28 px-2 md:px-8 lg:px-0">
                    <div className="flex flex-col gap-10 w-11/12 md:w-auto">
                        ...
                        <div className="flex flex-col gap-5 w-9/12 md:w-full mx-auto">
