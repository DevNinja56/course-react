        ...
        <>
            ...
            <div className="w-full pb-52">
                <div className="max-w-[1100px] 2xl:max-w-[2300px] mx-auto px-2 2xl:px-8 transition-all duration-300 pt-16">
                    <div className="w-full rounded-[10px] border-2 border-termsanduseBorderColor py-10 px-20 flex flex-col gap-y-4 bg-profileBgColor items-center mb-12">
                        <h1 className="text-textLightBlackColor font-bold">
                            Please read the privacy policy carefully as it
                            applies to your use of the Times Course Finder
                            (`&ldquo;`
                            <span className="text-blueColor">TCF</span>
                            `&ldquo;`) website (`&ldquo;`
                            <span className="text-blueColor">Website</span>
                            `&ldquo;`).
                        </h1>
                    ...
                    <div className="flex flex-col gap-y-8 mb-9">
                        ...
                        <div className="gap-5 flex flex-col">
                            ...
                            <div className="flex gap-3 items-center">
                                <div className="h-2 w-2 rounded--full bg-blueColor rounded-full"></div>
                                <p className="text-darkGrayColor leading-6">
                                    Recommending things which we think
                                    you`&ldquo;`ll like, such as courses and
                                    learning providers
                                </p>
                            </div>
                            <div className="flex gap-3 items-center">
                                <div className="h-2 w-2 rounded--full bg-blueColor rounded-full"></div>
                                <p className="text-darkGrayColor leading-6">
                                    Notifying you about things you`&ldquo;`ve
                                    told us you like, such as a new course in
                                    your local area
                                </p>
                            </div>
                            <div className="flex gap-3 items-center">
