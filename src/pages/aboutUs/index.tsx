...
const AboutUs = () => {
    return (
        <div className="2xl:container 2xl:mx-auto overflow-hidden">
            ...
            <div className="2xl:container 2xl:mx-auto overflow-hidden">
                <div className="bg-[#2B79FF] w-full relative h-fit flex flex-col">
                    <div className="flex flex-col justify-center items-center self-center text-center w-11/12 md:w-1/2 z-10 mt-6">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-white w-full md:w-3/4 text-xs md:text-sm">
                                Our platform provides localized entry
                                requirements based on your country of education,
                                ensuring you see only relevant criteria for your
                                application.
                            </p>

                            <Link
                                href={ROUTES.SMART_MATCH_TOOL}
                                className="  my-10"
                            >
                    ...
                    <img
                        ...
                        alt="WorldMap"
                        className="h-auto lg:h-72 drop-shadow-2xl object-contain"
                    />
                </div>
            </div>
            <FAQ />
