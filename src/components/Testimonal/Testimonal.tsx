                    ...
                    <div className="flex flex-col items-center gap-y-7">
                        <div className="bg-white rounded-[10px] py-5 px-5 pr-6 flex flex-col gap-y-4 custom-shadow z-10">
                            ...
                            <p className="text-grayColor text-sm mb-1">
                                Curabitur tristique, sem id sagittis varius,
                                lacus ligula mollis dui, ac condimentum felis
                                metus ut nulla. Aenean ut ultricies turpis, sed
                                sollicitudin eros. Aliquam quis dui ut diam
                                lobortis dignissim ut aliquet ex
                            </p>
                        </div>
