...
const Header = ({ onlyLogo }: { onlyLogo?: boolean }) => {
    ...
    return (
        <header className={`w-full fixed top-0 left-0 z-40 print:static`}>
                        ...
                        <div className="flex items-center print:hidden gap-x-3 xl:gap-x-6">
                            ...
                            <div className="flex items-center gap-x-2 md:gap-x-3">
                                <img
                                    ...
                                    className="block lg:hidden h-7 w-7 md:h-11 md:w-11"
                                    src="/images/Menu.svg"
                                    // priority
                                />
                                {isAuthenticated ? (
                                    <div
                                        ref={dropDownRef}
                                        className="flex items-center gap-x-1.5 relative select-none cursor-pointer"
                                        onClick={onShowDropDown}
                                    >
                                        {user.avatar ? (
                                            <img
                                                src={user.avatar}
                                                className="border rounded-full h-8 min-w-8"
                                                alt="Profile Photo"
                                                width={24}
                                                height={24}
                                            />
