...
const Accordion: React.FC<propsType> = ({
    ...
    return (
        <>
            <button
                className="flex text-[16px] px-[30px] py-[25.5px] font-bold h-[72px] w-full items-center justify-between border border-grayColor border-opacity-10 bg-white z-30"
                onClick={activeFun}
            >
                <p>{title}</p>
