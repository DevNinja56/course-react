    ...
    return (
        ...
        >
            ...
            <div className={`w-full py-16`}>
                <div className="container mx-auto px-3 lg:px-2 2xl:px-6 transition-all duration-300 flex flex-col items-center gap-y-16">
                    <div className="flex flex-col items-center gap-y-12">
                        <h1 className="font-bold text-3xl text-mainTextColor text-center">
            ...
            {router.pathname !== ROUTES.ABOUT_US && (
                <div className="flex flex-col items-center gap-y-16 mx-auto w-10/12 xl:w-9/12">
                    <div className="flex flex-col items-center gap-y-2">
                        <h1 className="font-bold text-3xl text-mainTextColor text-center">
                            How does Counselling Work?
                        </h1>
                        <p className="text-darkGrayColor text-center text-sm">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 justify-between relative z-10 gap-[56px] lg:gap-0 w-full px-0 md:px-8 lg:px-0">
                        ...
                        <div className="flex flex-col gap-[28px] items-center">
                            <div className="border-[3px] border-dashed border-[#717070] h-28 w-28 md:h-32 md:w-32 rounded-full flex items-center justify-center bg-white z-10">
                                <img
                            ...
                            <h1 className="font-bold text-base text-darkGrayColor text-center">
                                Send Academic <br />
                                Documents
                            </h1>
                        </div>
                        ...
                        <div className="flex flex-col gap-[28px] items-center">
                            ...
                            <h1 className="font-bold text-base text-darkGrayColor text-center w-[114px] lg:w-auto">
